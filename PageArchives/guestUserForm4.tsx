          ...
          <div className="form-center form-top-room">
            ...
            <div className='row'>
                <div className='four columns'>
                    ...
                    <input className='u-full-width' type="text" placeholder='Emergency Contact First Name' onChange={handleChange} />
                </div>
                <div className='four columns'>
                    <label>Emergency Contact Last Name</label>
                    <input className='u-full-width' type="text" placeholder='Emergency Contact Last Name' onChange={handleChange} />
                </div>
            </div>
            <div className='row'>
                <div className='four columns'>
                    <label>Emergency Contact Mobile Phone</label>
                    <input className='u-full-width' type="text" placeholder='Emergency Contact Mobile' onChange={handleChange} />
                </div>
                <div className='four columns'>
                    <label>Emergency Contact Work Phone</label>
                    <input className='u-full-width' type="email" placeholder='Emergency Contact Work Phone' onChange={handleChange} />
                </div>
                <div className='four columns'>
                    <label>Emergency Contact Work Phone</label>
                    <input className='u-full-width' type="email" placeholder='Emergency Contact Email' onChange={handleChange} />
                </div>
            </div>
            </div>
            <div className="row">
